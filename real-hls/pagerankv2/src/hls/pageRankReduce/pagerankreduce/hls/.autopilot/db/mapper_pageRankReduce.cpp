...
extern "C" void pageRankReduce(__cosim_s64__*, __cosim_s64__*, long long*);
extern "C" void apatb_pageRankReduce_hw(volatile void * __xlx_apatb_param_taskOutGlobal, volatile void * __xlx_apatb_param_taskIn, volatile void * __xlx_apatb_param_argOut) {
...
auto* sargOut = createStream((hls::stream<long long>*)__xlx_apatb_param_argOut);
  // DUT call
  pageRankReduce(staskOutGlobal->data<__cosim_s64__>(), staskIn->data<__cosim_s64__>(), sargOut->data<long long>());
