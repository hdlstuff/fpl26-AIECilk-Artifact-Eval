...
module elasticDemux_StreamSplitter_256_64(	// src/main/scala/chext/elastic/Demux.scala:9:7
...
module StreamSplitter_Basic_256_64_StreamSplitter_256_64(	// src/main/scala/accel/bugra/StreamSplitter.scala:36:7
  ...
  output [63:0]  outputs_1_TDATA	// src/main/scala/accel/bugra/StreamSplitter.scala:56:7
);

  wire         _fork0_demux0_io_source_ready;	// src/main/scala/accel/bugra/StreamSplitter.scala:64:25
  wire [255:0] _fork0_demux0_io_sinks_1_bits;	// src/main/scala/accel/bugra/StreamSplitter.scala:64:25
  ...
  elasticDemux_StreamSplitter_256_64 fork0_demux0 (	// src/main/scala/accel/bugra/StreamSplitter.scala:64:25
    ...
    .io_sinks_1_bits  (_fork0_demux0_io_sinks_1_bits),
  ...
  assign outputs_1_TDATA = _fork0_demux0_io_sinks_1_bits[63:0];	// src/main/scala/accel/bugra/StreamSplitter.scala:36:7, :64:25, :75:18
endmodule

module StreamSplitter_256_64(	// src/main/scala/accel/bugra/StreamSplitter.scala:82:7
  ...
  output [63:0]  outputs_1_TDATA	// src/main/scala/accel/bugra/StreamSplitter.scala:93:7
);

  wire reset = ~reset_n;	// src/main/scala/accel/bugra/StreamSplitter.scala:82:7, <stdin>:206:11
  StreamSplitter_Basic_256_64_StreamSplitter_256_64 dut (	// src/main/scala/accel/bugra/StreamSplitter.scala:89:19
    .clock            (clock),
    .reset            (reset),
