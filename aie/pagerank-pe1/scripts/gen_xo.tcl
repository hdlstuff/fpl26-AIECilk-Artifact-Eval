...
if { $krnl_name == "pageRankHS" } {
    source -notrace ./scripts/package_kernel_hs.tcl
} elseif { $krnl_name == "AxiPageBoundarySplitter_Basic_64_32_12_8" } {
    source -notrace ./scripts/package_kernel_axisplitter.tcl
} else {
    source -notrace ./scripts/package_kernel_oneaxi.tcl
}
