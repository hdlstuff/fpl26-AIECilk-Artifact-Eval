...
add_files -norecurse ${path_to_hdl}/UpSize_128_256.sv
add_files -norecurse ${path_to_hdl}/chext_mem_1w1r.sv

# Set unique library name
set_property library u0006 [get_files ${path_to_hdl}/UpSize_128_256.sv]
set_property library u0006 [get_files ${path_to_hdl}/chext_mem_1w1r.sv]
