...
add_files -norecurse ${path_to_hdl}/DownSize_512_128.sv
add_files -norecurse ${path_to_hdl}/chext_mem_1w1r.sv

# Set unique library name
set_property library u0001 [get_files ${path_to_hdl}/DownSize_512_128.sv]
set_property library u0001 [get_files ${path_to_hdl}/chext_mem_1w1r.sv]
