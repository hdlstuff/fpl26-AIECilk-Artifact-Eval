...
add_files -norecurse ${path_to_hdl}/StreamSplitter_64_512.sv
add_files -norecurse ${path_to_hdl}/chext_mem_1w1r.sv

# Set unique library name
set_property library u0005 [get_files ${path_to_hdl}/StreamSplitter_64_512.sv]
set_property library u0005 [get_files ${path_to_hdl}/chext_mem_1w1r.sv]
