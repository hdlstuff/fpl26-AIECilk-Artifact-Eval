...
void read_hs(input_stream_uint32 *in, paper_exp2_task_args &args, bool& tlast) {
...
void read_hs(input_stream_uint32 *in, paper_exp2_task2_args &args, bool& tlast) {
  read_hs(in, args.delay, tlast);
  read_hs(in, args._padding1, tlast);
  read_hs(in, args.cont, tlast);
}
...
void write_hs(output_stream_uint32 *out, paper_exp2_task_args &args, bool tlast) {
...
void write_hs(output_stream_uint32 *out, paper_exp2_task2_args &args, bool tlast) {
  write_hs(out, args.delay, false);
  write_hs(out, args._padding1, false);
  write_hs(out, args.cont, tlast);
}
