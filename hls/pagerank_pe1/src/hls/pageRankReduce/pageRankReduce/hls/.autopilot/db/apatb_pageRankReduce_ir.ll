; ModuleID = '/home/shahawy/vitis_testing/pageRank/pageRankReduce/pageRankReduce/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  %3 = alloca %"class.hls::stream<unsigned long, 0>"
  call void @copy_out(%"class.hls::stream<vertex_map_args, 0>"* null, %"class.hls::stream<vertex_map_args, 0>"* %0, %"class.hls::stream<pageRankReduce_args, 0>"* null, %"class.hls::stream<pageRankReduce_args, 0>"* %1, %"class.hls::stream<unsigned long, 0>"* %3, i64* %2)
  call void @pageRankReduce_hw_stub(%"class.hls::stream<vertex_map_args, 0>"* %0, %"class.hls::stream<pageRankReduce_args, 0>"* %1, %"class.hls::stream<unsigned long, 0>"* %3)
  call void @copy_in(%"class.hls::stream<vertex_map_args, 0>"* null, %"class.hls::stream<vertex_map_args, 0>"* %0, %"class.hls::stream<pageRankReduce_args, 0>"* null, %"class.hls::stream<pageRankReduce_args, 0>"* %1, %"class.hls::stream<unsigned long, 0>"* %3, i64* %2)
  ret void
}
