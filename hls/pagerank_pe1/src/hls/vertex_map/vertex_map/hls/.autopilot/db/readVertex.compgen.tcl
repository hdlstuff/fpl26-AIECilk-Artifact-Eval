...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { v_neighbours_stream_dout { I 64 vector } v_neighbours_stream_num_data_valid { I 5 vector } v_neighbours_stream_fifo_cap { I 5 vector } v_neighbours_stream_empty_n { I 1 bit } v_neighbours_stream_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { v_size_0_dout { I 32 vector } v_size_0_num_data_valid { I 5 vector } v_size_0_fifo_cap { I 5 vector } v_size_0_empty_n { I 1 bit } v_size_0_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { adj_lists_dout { I 64 vector } adj_lists_num_data_valid { I 5 vector } adj_lists_fifo_cap { I 5 vector } adj_lists_empty_n { I 1 bit } adj_lists_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_Pcurrs \
    op interface \
    ports { Pcurrs_dout { I 64 vector } Pcurrs_num_data_valid { I 5 vector } Pcurrs_fifo_cap { I 5 vector } Pcurrs_empty_n { I 1 bit } Pcurrs_read { O 1 bit } } \
} "
}
