...
set portList { 
	...
	{ adder_in_feed_0_num_data_valid sc_in sc_lv 8 signal 2 } 
	{ adder_in_feed_0_fifo_cap sc_in sc_lv 8 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "v_size_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "9", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "v_size_1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "adder_results", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "128", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_feed_adder_value_Pipeline_VITIS_LOOP_138_2_fu_36", "Port" : "adder_results", "Inst_start_state" : "5", "Inst_end_state" : "6"}]},
			{"Name" : "adder_in_feed_0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "128", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_feed_adder_value_Pipeline_VITIS_LOOP_133_1_fu_30", "Port" : "adder_in_feed_0", "Inst_start_state" : "2", "Inst_end_state" : "3"},
					{"ID" : "3", "SubInstance" : "grp_feed_adder_value_Pipeline_VITIS_LOOP_138_2_fu_36", "Port" : "adder_in_feed_0", "Inst_start_state" : "5", "Inst_end_state" : "6"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_feed_adder_value_Pipeline_VITIS_LOOP_133_1_fu_30", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_feed_adder_value_Pipeline_VITIS_LOOP_133_1_fu_30.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_feed_adder_value_Pipeline_VITIS_LOOP_138_2_fu_36", "Parent" : "0", "Child" : ["4"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_138_2", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_feed_adder_value_Pipeline_VITIS_LOOP_138_2_fu_36.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"}]}
...
set Spec2ImplPortList { 
	v_size_1 { ap_fifo {  { v_size_1_dout fifo_data_in 0 32 }  { v_size_1_num_data_valid fifo_status_num_data_valid 0 5 }  { v_size_1_fifo_cap fifo_update 0 5 }  { v_size_1_empty_n fifo_status 0 1 }  { v_size_1_read fifo_port_we 1 1 } } }
	adder_results { ap_fifo {  { adder_results_dout fifo_data_in 0 32 }  { adder_results_num_data_valid fifo_status_num_data_valid 0 8 }  { adder_results_fifo_cap fifo_update 0 8 }  { adder_results_empty_n fifo_status 0 1 }  { adder_results_read fifo_port_we 1 1 } } }
	adder_in_feed_0 { ap_fifo {  { adder_in_feed_0_din fifo_data_in 1 32 }  { adder_in_feed_0_num_data_valid fifo_status_num_data_valid 0 8 }  { adder_in_feed_0_fifo_cap fifo_update 0 8 }  { adder_in_feed_0_full_n fifo_status 0 1 }  { adder_in_feed_0_write fifo_port_we 1 1 } } }
}
