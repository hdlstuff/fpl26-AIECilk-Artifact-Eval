...
void inline logAllRpause(xrt::ip &ip) {
  ...
  logRpause(ip, REG_FIB_SCHEDULER_0_FIFOHEADREG, "sum (fib) fifo head 0");
  logRpause(ip, REG_FIB_SCHEDULER_0_FIFOTAILREG, "sum (fib) fifo tail 0");
}
