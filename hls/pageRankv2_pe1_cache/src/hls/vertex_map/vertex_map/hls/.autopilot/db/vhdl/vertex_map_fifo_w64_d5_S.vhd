...
entity vertex_map_fifo_w64_d5_S is 
    generic (
...
architecture rtl of vertex_map_fifo_w64_d5_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component vertex_map_fifo_w64_d5_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 5);
...
begin
----------------------- Instantiation -----------------------
    U_vertex_map_fifo_w64_d5_S_ShiftReg : vertex_map_fifo_w64_d5_S_ShiftReg
    generic map (
...
entity vertex_map_fifo_w64_d5_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 5);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end vertex_map_fifo_w64_d5_S_ShiftReg;

architecture rtl of vertex_map_fifo_w64_d5_S_ShiftReg is
