...
set portList { 
	...
	{ adder_results_num_data_valid sc_in sc_lv 32 signal 2 } 
	{ adder_results_fifo_cap sc_in sc_lv 32 signal 2 } 
...
set Spec2ImplPortList { 
	v_size_2 { ap_fifo {  { v_size_2_dout fifo_data_in 0 32 }  { v_size_2_empty_n fifo_status 0 1 }  { v_size_2_read fifo_port_we 1 1 }  { v_size_2_num_data_valid fifo_status_num_data_valid 0 5 }  { v_size_2_fifo_cap fifo_update 0 5 } } }
	sums_stream { ap_fifo {  { sums_stream_din fifo_data_in 1 32 }  { sums_stream_full_n fifo_status 0 1 }  { sums_stream_write fifo_port_we 1 1 }  { sums_stream_num_data_valid fifo_status_num_data_valid 0 5 }  { sums_stream_fifo_cap fifo_update 0 5 } } }
