...
set portList { 
	...
	{ argOut_TDATA sc_out sc_lv 64 signal 6 } 
	{ taskIn_TVALID sc_in sc_logic 1 invld 5 } 
	{ taskIn_TREADY sc_out sc_logic 1 inacc 5 } 
	{ argOut_TVALID sc_out sc_logic 1 outvld 6 } 
	{ argOut_TREADY sc_in sc_logic 1 outacc 6 } 
}
set NewPortList {[ 
...
set ArgLastReadFirstWriteLatency {
	...
	adder_function {
		...
		sums_stream {Type O LastRead -1 FirstWrite 4}
	...
	adder_function_Pipeline_VITIS_LOOP_117_1 {
		v_size {Type I LastRead 0 FirstWrite -1}
		adder_in_feed_0 {Type I LastRead 1 FirstWrite -1}
		adder_in_feed_1 {Type I LastRead 1 FirstWrite -1}
		adder_results {Type O LastRead -1 FirstWrite 9}}
...
dict set maxi_interface_dict gmem_CHN_1 { CHANNEL_NUM 1 BUNDLE gmem NUM_READ_OUTSTANDING 64 NUM_WRITE_OUTSTANDING 1 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 READ_WRITE_MODE READ_ONLY NUM_CACHE_LINES 2 CACHE_LINE_DEPTH 4 CACHE_LINE_WIDTH 64 NUM_L1_CACHE_PORTS 1 NUM_L2_CACHE_LINES 0 CACHE_MEM_IMPL auto}
dict set maxi_interface_dict gmem_CHN_2 { CHANNEL_NUM 2 BUNDLE gmem NUM_READ_OUTSTANDING 64 NUM_WRITE_OUTSTANDING 1 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 READ_WRITE_MODE READ_ONLY NUM_CACHE_LINES 2 CACHE_LINE_DEPTH 4 CACHE_LINE_WIDTH 64 NUM_L1_CACHE_PORTS 1 NUM_L2_CACHE_LINES 0 CACHE_MEM_IMPL auto}
dict set maxi_interface_dict gmem_CHN_5 { CHANNEL_NUM 5 BUNDLE gmem NUM_READ_OUTSTANDING 64 NUM_WRITE_OUTSTANDING 1 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 READ_WRITE_MODE WRITE_ONLY}
