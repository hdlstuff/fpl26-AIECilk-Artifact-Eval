...
unsigned int ap_apatb_argOut_cap_bc;
static AESL_RUNTIME_BC __xlx_argOut_V_size_Reader("../tv/stream_size/stream_size_out_argOut.dat");
using hls::sim::Byte;
struct __cosim_s64__ { char data[64]; };
extern "C" void vertex_map(Byte<8>*, Byte<8>*, Byte<8>*, Byte<8>*, int, int, int, int, __cosim_s64__*, long long*);
extern "C" void apatb_vertex_map_hw(volatile void * __xlx_apatb_param_mem_0, volatile void * __xlx_apatb_param_mem_1, volatile void * __xlx_apatb_param_mem_2, volatile void * __xlx_apatb_param_mem_5, volatile void * __xlx_apatb_param_taskIn, volatile void * __xlx_apatb_param_argOut) {
...
auto* staskIn = createStream((hls::stream<__cosim_s64__>*)__xlx_apatb_param_taskIn);
  //Create input buffer for argOut
  ap_apatb_argOut_cap_bc = __xlx_argOut_V_size_Reader.read_size();
  long long* __xlx_argOut_input_buffer= new long long[ap_apatb_argOut_cap_bc];
auto* sargOut = createStream((hls::stream<long long>*)__xlx_apatb_param_argOut);
  // DUT call
  vertex_map(__xlx_mem_0__tmp_vec.data(), __xlx_mem_1__tmp_vec.data(), __xlx_mem_2__tmp_vec.data(), __xlx_mem_5__tmp_vec.data(), __xlx_offset_byte_param_mem_0, __xlx_offset_byte_param_mem_1, __xlx_offset_byte_param_mem_2, __xlx_offset_byte_param_mem_5, staskIn->data<__cosim_s64__>(), sargOut->data<long long>());
...
sargOut->transfer((hls::stream<long long>*)__xlx_apatb_param_argOut);
}
