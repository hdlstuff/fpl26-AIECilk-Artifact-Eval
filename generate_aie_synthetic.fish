...
set -l SYNTHETIC_DIR $ROOT_DIR/synthetic
...
for bench_dir in $bench_dirs
    ...
    for config_file in $config_files
        ...
        for pe in $pe_values
            ...
            sbt "runMain HardCilk.HardCilkEmitter -k $temp_cfg" 2>&1
            ...
            sbt "runMain HardCilk.HardCilkEmitter -g $temp_cfg" 2>&1
            ...
            set -l out_name $config_stem"_pe"$pe
